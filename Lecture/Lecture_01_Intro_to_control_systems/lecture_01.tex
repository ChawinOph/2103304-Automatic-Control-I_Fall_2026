        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[very thick, blue, const plot mark left] coordinates {
...
\begin{frame}{Unit Impulse Response}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            Strike the system with a unit impulse $\delta(t)$, a sharp ``hammer blow.''
            \newline \newline
            The output $h(t)$ is the \emph{unit impulse response}: a signature of the system's natural behavior.
            % \[
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}
                \begin{groupplot}[
                    ...
                    \nextgroupplot[ylabel={$\delta(t)$}, ymin=0, ymax=1.4]
                        % \addplot[gray, opacity=0.5, thick, domain=0:8] {0};
                        \addplot[very thick, blue, -{Stealth[length=2.5mm]}] coordinates {(0,0) (0,1)};
                        % \node[brandred, anchor=south west] at (axis cs:0.15,0.9) {\small (area $=1$)};
                    % bottom: output -- impulse response h(t)
                    \nextgroupplot[ylabel={$h(t)$}, ymin=0, ymax=0.6]
                        % \addplot[gray, opacity=0.5, thick, domain=0:8] {0};
...
% \begin{frame}
%     Key Property II: The integral of the delta function over all space is exactly 1
%     \[
%         \int_{-\infty}^{\infty}\!\! f(t)\,\delta(t)\,dt = f(0).
%     \]
% \end{frame}

    % each unit impulse will create a "unit impulse response" $h(t)$ 
