...
\begin{frame}{}
    ...
    % \end{tikzpicture}
    Pictures of Elvators, Air Conditioners, Crane, Process Plants, Industrial Robots, Humanoid Robots, Biped Robots, Surgical Robots (Da Vinci), etc.
\end{frame}
% \footnotetext{\url{}} 
    % SpaceX Rocket 
    % Elevators
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    x tick label style ={
                        ...
                        xshift=3pt,   % extrahotizontal shift 
                        yshift=-3pt
                    },
                    xtick={0.875}, xticklabels={$t_0$}, ytick={1},
                    axis x line=middle, axis y line=middle,
                    every axis x label/.style={at={(current axis.right of origin)},anchor=north west},
                    every axis y label/.style={at={(current axis.above origin)},anchor=south},
                    clip=false,
