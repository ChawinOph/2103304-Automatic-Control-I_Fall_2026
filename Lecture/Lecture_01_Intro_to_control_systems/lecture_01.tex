...
\begin{frame}{Linear Time-Invariant System (LTI)}
    ...
    % \centering
    \vspace{1em}
    An \emph{LTI} system is \emph{linear} (homogeneity $+$ additivity = superposition) and \emph{time-invariant}. Hence a weighted sum of shifted impulses produces the same weighted sum of shifted impulse responses:
    \[
...
% link sifing property
% link to convolution a way to describe arbritary function f(t)
% taking convolution integral on both input and output sides
% Get back to the square pulse
