...
\begin{frame}{LTI: Input-Output}
    \begin{columns}[c]
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    width=\linewidth, height=4cm,
                    xmin=0, xmax=4.5, ymin=-0.1, ymax=1.4,
                    ticks=none,
                    xlabel={$t$}, ylabel={$f(t)$},
                    axis lines=center,
                    axis line style={-{Stealth[length=2mm]}},
                    ...
                    \only{
                        \addplot[thick, red, -{Stealth[length=2.5mm]}] coordinates {(1,0) (1,1)};
                        \addplot[thick, red, -{Stealth[length=2.5mm]}] coordinates {(1.2,0) (1.2,1)};
                        \addplot[thick, red, , -{Stealth[length=2.5mm]}] coordinates {(1.4,0) (1.4,1)};
                        \addplot[thick, red, , -{Stealth[length=2.5mm]}] coordinates {(1.6,0) (1.6,1)};
                        \addplot[thick, red, , -{Stealth[length=2.5mm]}] coordinates {(1.8,0) (1.8,1)};
                    }<1>
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \only{
                        \addplot[thick, red,   opacity=0.25, smooth, samples=200, domain=1:4]
                        {1/sqrt(2) * exp(-x + 1) * sin(deg(sqrt(2)*(x - 1)))};
                        \addplot[thick, red,   opacity=0.25, smooth, samples=200, domain=1.2:4]
                        {1/sqrt(2) * exp(-x + 1.2) * sin(deg(sqrt(2)*(x-1.2)))};
                        \addplot[thick, red,   opacity=0.25, smooth, samples=200, domain=1.4:4]
                        {1/sqrt(2) * exp(-x + 1.4) * sin(deg(sqrt(2)*(x - 1.4)))};
                        \addplot[thick, red,   opacity=0.25, smooth, samples=200, domain=1.6:4]
                        {1/sqrt(2) * exp(-x + 1.6) * sin(deg(sqrt(2)*(x - 1.6)))};
                         \addplot[thick, red,  opacity=0.25, smooth, samples=200, domain=1.8:4]
                        {1/sqrt(2) * exp(-x + 1.8) * sin(deg(sqrt(2)*(x - 1.8)))};
                        \addplot[very thick, red,   opacity=1.0, smooth, samples=200, domain=1:4]
    ...
    % \centering
    \vspace{1em}
    LTI system: a weighted sum of shifted impulses produces the same weighted sum of shifted impulse responses
    \only{\[
        f(t) = \sum_i a_i\,\delta(t - t_i) \;\longrightarrow\; x(t) = \sum_i a_i\,h(t - t_i).
    \]}<1>
    \only{\[
...
% Convolution
\begin{frame}{Convolution: Interpretation}
...
\begin{frame}
    Form a group of 3-4 student and register in MCV
\end{frame}
